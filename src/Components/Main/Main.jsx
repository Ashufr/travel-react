...
const Data = [
  {
    ...
    fees: "$900",
    description:
      "An immense mausoleum of white marble, built-in Agra by Mughal emperor Shah Jahan in the memory of his wife Mumtaz, the monument is breathtakingly beautiful. This place is known for its luxurious stays and adventurous activities.",
  },
  {
    id: 2,
    imgSrc: img2,
  ...
  },
  {
    ...
    fees: "$700",
    description:
      "One of the most remarkable Australian natural gifts is the Great and & eautyn. Always Barrier Reef. The hallmark of this place is interesting to be in this place",
  },
  {
    id: 5,
    imgSrc: img5,
    ...
    fees: "$800",
    description:
      "According to the World Tourism Ranking, 45 Million people visit Turkey each year, and from that about 2 Million to visit Cappadocia. This place is known for its luxurious stays and adventurous activities",
  },
  {
    id: 6,
    imgSrc: img6,
  ...
  },
  {
    ...
    fees: "$750",
    description:
      "Angkot wat represents the entire range of Khmer art from the 9th to the 15th century. This temple is considered the heart and soul of Cambodia. This place is known for it's luxurious stays and adventurous activities",
  },
  {
    id: 9,
    imgSrc: img9,
  ...
  return (
    <section className="main container section">
      <div className="sec-title">
        <h3 data-aos="fade-right" className="title">Most Visited Desinations</h3>
      </div>
      <div className="section-content grid">
        {Data.map(
          ({ id, imgSrc, destTitle, location, grade, fees, description }) => {
            ...
            return (
              <div data-aos="fade-up" data-aos-duration="500" key={id}  className="single-dest">
